...
export function CategoryIcons() {
  return (
    <section className="container !max-w-none mx-auto px-4 lg:px-12 pt-8 pb-8 md:pt-12 md:pb-16">
      <h2 className="text-center text-xl md:text-3xl font-black mb-8 md:mb-12 text-gray-800">خرید بر اساس دسته‌بندی</h2>
