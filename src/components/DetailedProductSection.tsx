  ...
  return (
    <section className="max-w-[1440px] mx-auto px-4 md:px-8 py-8 md:py-12">
      <div className="flex items-center justify-between mb-6 md:mb-10 border-b border-gray-100 pb-4 px-2">
        <button onClick={() => onProductClick?.(activeProducts[0].id)} className="text-xs md:text-sm font-black text-blue-500 hover:text-blue-600 transition-colors">مشاهده همه</button>
        <h2 className="text-lg md:text-2xl font-black text-gray-800">داغ‌ترین‌های متین‌کالا</h2>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 md:gap-6 px-1">
